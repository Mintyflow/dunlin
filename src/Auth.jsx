  ...
  const sidebar = (
    <div style={{ background: C.dt, width: 360, minHeight: '100vh', padding: '48px 40px', display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <svg width="26" height="18" viewBox="0 0 120 80" fill="none">
          <ellipse cx="62" cy="46" rx="28" ry="16" stroke={C.sand} strokeWidth="1.5" fill="none"/>
          <circle cx="88" cy="34" r="10" stroke={C.sand} strokeWidth="1.5" fill="none"/>
          <path d="M96 36 Q108 36 112 40" stroke={C.sand} strokeWidth="1.5" strokeLinecap="round" fill="none"/>
          <path d="M35 46 Q22 40 18 44" stroke={C.sand} strokeWidth="1.5" strokeLinecap="round" fill="none"/>
          <line x1="58" y1="60" x2="54" y2="72" stroke={C.sand} strokeWidth="1.3" strokeLinecap="round"/>
          <line x1="70" y1="61" x2="68" y2="72" stroke={C.sand} strokeWidth="1.3" strokeLinecap="round"/>
        </svg>
